...
public class HistoricoAsociaciones extends JFrame implements Vista{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HistoricoAsociaciones frame = new HistoricoAsociaciones();
					frame.setVisible(true);
					frame.setTitle("Historico Asociaciones");
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
